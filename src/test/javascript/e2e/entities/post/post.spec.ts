...
describe('Post e2e test', () => {
  ...
  it('should load Posts', async () => {
    ...
    expect(await postComponentsPage.getTitle()).to.eq('testApp.post.home.title');
  ...
  it('should load create Post page', async () => {
    ...
    expect(await postUpdatePage.getPageTitle()).to.eq('testApp.post.home.createOrEditLabel');
  ...
  /* it('should create and save Posts', async () => {
        ...
        await promise.all([
            ...
            postUpdatePage.setRequiredInput('required'),
            postUpdatePage.setCreationDateInput('2000-12-31'),
            postUpdatePage.creatorSelectLastOption(),
        ]);
  ...
  /* it('should delete last Post', async () => {
        ...
        expect(await postDeleteDialog.getDialogTitle())
            .to.eq('testApp.post.delete.question');
